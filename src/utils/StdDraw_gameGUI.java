...
public final class StdDraw_gameGUI implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	...
	private static StdDraw_gameGUI std = new StdDraw_gameGUI();
	...
	private static Image getImage(String filename) {
		...
		if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
			URL url = StdDraw_gameGUI.class.getResource(filename);
			if (url != null)
				icon = new ImageIcon(url);
		}
	...
	public void mousePressed(MouseEvent e) {
		synchronized (mouseLock) {
			mouseX = StdDraw_gameGUI.userX(e.getX());
			mouseY = StdDraw_gameGUI.userY(e.getY());
			isMousePressed = true;
		}
	}
	 ...
	 */
	public static void main(String[] args) {
		StdDraw_gameGUI.square(0.2, 0.8, 0.1);
		StdDraw_gameGUI.filledSquare(0.8, 0.8, 0.2);
		StdDraw_gameGUI.circle(0.8, 0.2, 0.2);

		StdDraw_gameGUI.setPenColor(StdDraw_gameGUI.BOOK_RED);
		StdDraw_gameGUI.setPenRadius(0.02);
		StdDraw_gameGUI.arc(0.8, 0.2, 0.1, 200, 45);

		// draw a blue diamond
		StdDraw_gameGUI.setPenRadius();
		StdDraw_gameGUI.setPenColor(StdDraw_gameGUI.BOOK_BLUE);
		double[] x = { 0.1, 0.2, 0.3, 0.2 };
		double[] y = { 0.2, 0.3, 0.2, 0.1 };
		StdDraw_gameGUI.filledPolygon(x, y);

		// text
		StdDraw_gameGUI.setPenColor(StdDraw_gameGUI.BLACK);
		StdDraw_gameGUI.text(0.2, 0.5, "black text");
		StdDraw_gameGUI.setPenColor(StdDraw_gameGUI.WHITE);
		StdDraw_gameGUI.text(0.8, 0.8, "white text");
	}
